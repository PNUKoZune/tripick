...
관련 컨텍스트: [`CLAUDE.md`](../CLAUDE.md) §3 취향 분석 파이프라인·CRAG, [`docs/place-embedding-and-preference-personalization-v1.md`](./place-embedding-and-preference-personalization-v1.md) (임베딩 개인화 루프), [`docs/embedding-server-separation-v1.md`](./embedding-server-separation-v1.md) (원격 임베딩·해시 폴백)

...
관련 문서: [`docs/realtime-websocket-v1.md`](./realtime-websocket-v1.md) (replan 수신 인프라·게이트웨이 보안), [`docs/main-planner-v1.md`](./main-planner-v1.md) (Planner trip DTO), [`docs/mobile-webview-setup.md`](./mobile-webview-setup.md) (RN WebView 셸·FCM)

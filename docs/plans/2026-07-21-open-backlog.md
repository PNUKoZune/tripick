...
- [ ] 서울처럼 후보가 밀집한 지역의 풀 진입 — 청계천·한강공원·북촌한옥마을이 적재돼 있는데 유사도 상위 48(limit×3)에 안 들어와 랭킹 가중으로는 못 고친다. 인지도를 후보 선발 단계에 얹거나 밀집 지역만 N 을 키우는 안 ([ranking-tuning §6](../preference/retrieval-ranking-tuning-v1.md))

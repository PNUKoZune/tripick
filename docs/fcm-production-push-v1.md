...
관련 문서: [`docs/product-v1-scope.md`](./product-v1-scope.md) (2.E 재계획 — "푸시 알림 production 품질"·"자동 이탈 감지/FCM은 이후 단계"로 제외했던 항목), [`docs/realtime-websocket-v1.md`](./realtime-websocket-v1.md) (재계획 결과를 WebSocket으로만 내보내던 수신부), [`docs/inbox-and-trip-invite-v1.md`](./inbox-and-trip-invite-v1.md) (인박스·수신설정)

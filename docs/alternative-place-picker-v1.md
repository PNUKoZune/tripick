...
관련 문서: [`docs/main-planner-v1.md`](./main-planner-v1.md) (Screen 4 대안 팝업 초기 mock), [`docs/rag-crag-v1.md`](./rag-crag-v1.md) (CRAG 검색 파이프라인), [`docs/trip-progress-live-v1.md`](./trip-progress-live-v1.md) (Live 화면·재계획 수신), [`docs/place-embedding-and-preference-personalization-v1.md`](./place-embedding-and-preference-personalization-v1.md) (취향 벡터 개인화)

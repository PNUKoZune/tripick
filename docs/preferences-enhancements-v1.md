...
관련 문서: [`docs/place-embedding-and-preference-personalization-v1.md`](./place-embedding-and-preference-personalization-v1.md) (취향 벡터 개인화 검색), [`docs/rag-crag-v1.md`](./rag-crag-v1.md) (CRAG 검색), [`docs/settings-profile-v1.md`](./settings-profile-v1.md) (프로필 이미지 Object Storage 업로드 패턴), [`docs/trip-create-v1.md`](./trip-create-v1.md) (MUI 시계 피커 원본)

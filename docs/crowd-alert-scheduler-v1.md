...
선행 문서: [`docs/weather-alert-scheduler-v1.md`](./weather-alert-scheduler-v1.md) (동형 스케줄러·미러링 원본), [`docs/destination-tour-api-v1.md`](./destination-tour-api-v1.md) (KTO 지역코드), [`docs/inbox-and-trip-invite-v1.md`](./inbox-and-trip-invite-v1.md) (인박스·푸시)

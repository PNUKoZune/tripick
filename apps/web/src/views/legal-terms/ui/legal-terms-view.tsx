    ...
    <DocumentPageShell label="이용약관" title="이용약관" description={`시행일 ${LEGAL_UPDATED_AT}`}>
      ...
      <DocumentSection heading="제7조 (AI 추천의 한계와 면책)">
        <DocumentParagraph>
          ...
          추천 정보에 대한 완전성·정확성을 보증하지 않습니다. 특히 미도착·날씨·혼잡 알림은 일정
          조정을 &quot;추천&quot;할 뿐 일정을 자동으로 변경하지 않으므로, 알림의 지연·누락을 이유로
          한 여행 일정상의 손해에 대해서는 서비스가 책임을 지지 않습니다.
        </DocumentParagraph>
      </DocumentSection>
      ...
      <DocumentSection heading="제10조 (콘텐츠의 권리)">
        <DocumentParagraph>
          ...
          서비스는 회원의 콘텐츠를 광고·마케팅 소재로 사용하거나 AI 모델 학습 데이터로 제3자에게
          제공하지 않습니다.
        </DocumentParagraph>
      </DocumentSection>
      ...
      <DocumentSection heading="제12조 (서비스의 중단 및 공지)">
        <DocumentParagraph>
          ...
          중단할 수 있으며, 사전에 예측 가능한 경우 서비스 화면에 미리 공지합니다. 회원에 대한
          개별 통지가 필요한 경우에는 회원이 등록한 이메일 또는 앱 알림으로 통지합니다.
        </DocumentParagraph>
      </DocumentSection>

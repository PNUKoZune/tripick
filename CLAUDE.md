...
- 후보 검색·적재 카탈로그의 결정·근거·검증은 문서로 분리했다 — [docs/preference/destination-anchor-retrieval-v1.md](docs/preference/destination-anchor-retrieval-v1.md)(행정구역으로 안 잡히는 목적지의 좌표 앵커 반경 검색), [docs/preference/catalog-ingestion-gates-v1.md](docs/preference/catalog-ingestion-gates-v1.md)(KTO 쇼핑 소매 점포·축제 기간·적재 게이트), [docs/preference/retrieval-eval-harness-hardening-v1.md](docs/preference/retrieval-eval-harness-hardening-v1.md)(골든셋 교정·인지도 판정 게이트·측정 방법론)
